...
function sanitizeBaseStats(baseStats) {
    ...
    safe.dungeon2Entries = (baseStats && typeof baseStats.dungeon2Entries === 'number') ? baseStats.dungeon2Entries : 7;
...
const MonsterDatabase = {
    ...
    // 🌟 THE GOLDEN SLIME
    "common_mobs_golden": { name: "Golden Slime", category: "common_mobs", level: 5, maxHp: 100, atk: 15, def: 0, speed: 4.0, expYield: 1500, goldYield: 1500, aggroRadius: 250, chaseRadius: 500, attackRange: 55, width: 40, height: 40, respawnDelay: 10000, cssColor: '#ffd700', cssBorder: '#b8860b' },
    "mini_boss1": { name: "Orc Slime", category: "mini_boss", level: 15, maxHp: 5500, atk: 50, def: 25, speed: 2.8, expYield: 5500, goldYield: 3, aggroRadius: 350, chaseRadius: 500, attackRange: 90, width: 60, height: 60, respawnDelay: 120000, cssColor: '#2196F3', cssBorder: '#0b7dda' },
    "floor_boss1": { name: "Dragon Slime", category: "floor_boss", level: 25, maxHp: 35000, atk: 450, def: 100, speed: 3.5, expYield: 17000, goldYield: 5, aggroRadius: 500, chaseRadius: 700, attackRange: 130, width: 100, height: 100, respawnDelay: -1, cssColor: '#f44336', cssBorder: '#b71c1c' },
    // ==================
    // TYPE 2: BATS (Fast, Squishy, Melee)
    // ==================
    "common_mobs2": { name: "Shadow Bat", category: "common_mobs", level: 5, maxHp: 160, atk: 35, def: 0, speed: 4.5, expYield: 1130, goldYield: 1, aggroRadius: 300, chaseRadius: 500, attackRange: 55, width: 40, height: 40, respawnDelay: 10000, cssColor: '#1a1a1a', cssBorder: 'none' },
    "mini_boss2": { name: "Vampire Bat", category: "mini_boss", level: 15, maxHp: 13700, atk: 280, def: 5, speed: 5.0, expYield: 6600, goldYield: 3, aggroRadius: 400, chaseRadius: 600, attackRange: 90, width: 60, height: 60, respawnDelay: 120000, cssColor: '#8a2be2', cssBorder: 'none' },
    "floor_boss2": { name: "Bloodwing Terror", category: "floor_boss", level: 25, maxHp: 35500, atk: 530, def: 35, speed: 6.0, expYield: 19500, goldYield: 5, aggroRadius: 600, chaseRadius: 800, attackRange: 130, width: 100, height: 100, respawnDelay: -1, cssColor: '#d32f2f', cssBorder: 'none' },

    // ==================
    // TYPE 3: FIRE ELEMENTALS (Glass Cannons, Ranged)
    // ==================
    "common_mobs3": { name: "Fire Sprite", category: "common_mobs", level: 5, maxHp: 180, atk: 50, def: 0, speed: 2.5, expYield: 1135, goldYield: 1, aggroRadius: 350, chaseRadius: 500, attackRange: 200, width: 40, height: 40, respawnDelay: 10000, cssColor: '#f44336', cssBorder: 'none' },
    "mini_boss3": { name: "Inferno Core", category: "mini_boss", level: 15, maxHp: 14200, atk: 320, def: 25, speed: 2.8, expYield: 7700, goldYield: 3, aggroRadius: 450, chaseRadius: 650, attackRange: 250, width: 60, height: 60, respawnDelay: 120000, cssColor: '#ff9800', cssBorder: 'none' },
    "floor_boss3": { name: "Astral Blaze", category: "floor_boss", level: 25, maxHp: 37500, atk: 600, def: 75, speed: 3.5, expYield: 24000, goldYield: 5, aggroRadius: 800, chaseRadius: 900, attackRange: 300, width: 100, height: 100, respawnDelay: -1, cssColor: 'linear-gradient(45deg, #2196F3, #ff9800)', cssBorder: 'none' },

    // ==================
    // TYPE 4: STONE GOLEMS (Massive Tanks, Slow, High Defense)
    // ==================
    "common_golem": { name: "Stone Golem", category: "common_mobs", level: 10, maxHp: 400, atk: 45, def: 20, speed: 1.5, expYield: 1160, goldYield: 1, aggroRadius: 200, chaseRadius: 350, attackRange: 60, width: 50, height: 50, respawnDelay: 12000, cssColor: '#795548', cssBorder: '#4E342E' },
    "mini_boss_golem": { name: "Obsidian Behemoth", category: "mini_boss", level: 15, maxHp: 28000, atk: 350, def: 75, speed: 1.8, expYield: 6900, goldYield: 3, aggroRadius: 300, chaseRadius: 450, attackRange: 90, width: 80, height: 80, respawnDelay: 120000, cssColor: '#424242', cssBorder: '#212121' },
    "floor_boss_golem": { name: "Titan of the Deep", category: "floor_boss", level: 25, maxHp: 100000, atk: 350, def: 350, speed: 2.2, expYield: 26000, goldYield: 5, aggroRadius: 400, chaseRadius: 600, attackRange: 140, width: 120, height: 120, respawnDelay: -1, cssColor: 'linear-gradient(45deg, #5D4037, #212121)', cssBorder: '#3E2723' },

    // ==================
    // TYPE 5: SPECTRAL WRAITHS (Ethereal, Fast, Ranged Assassins)
    // ==================
    "common_wraith": { name: "Spectral Wraith", category: "common_mobs", level: 10, maxHp: 150, atk: 75, def: 0, speed: 4.8, expYield: 1165, goldYield: 1, aggroRadius: 400, chaseRadius: 600, attackRange: 250, width: 40, height: 40, respawnDelay: 10000, cssColor: 'rgba(156, 39, 176, 0.7)', cssBorder: '#7B1FA2' },
    "mini_boss_wraith": { name: "Soul Reaper", category: "mini_boss", level: 15, maxHp: 11000, atk: 480, def: 10, speed: 5.5, expYield: 9300, goldYield: 3, aggroRadius: 500, chaseRadius: 700, attackRange: 300, width: 60, height: 60, respawnDelay: 120000, cssColor: 'rgba(103, 58, 183, 0.8)', cssBorder: '#512DA8' },
    "floor_boss_wraith": { name: "The Void King", category: "floor_boss", level: 25, maxHp: 45000, atk: 800, def: 100, speed: 6.5, expYield: 26500, goldYield: 5, aggroRadius: 700, chaseRadius: 1000, attackRange: 350, width: 100, height: 100, respawnDelay: -1, cssColor: 'linear-gradient(45deg, #4A148C, #000000)', cssBorder: '#311B92' },

    // ==================
    // TYPE 6: MINOTAURS (Brute Force, Charging Tanks)
    // ==================
    "common_minotaur": { name: "Minotaur Grunt", category: "common_mobs", level: 10, maxHp: 600, atk: 65, def: 15, speed: 2.0, expYield: 1180, goldYield: 2, aggroRadius: 300, chaseRadius: 450, attackRange: 60, width: 60, height: 60, respawnDelay: 12000, cssColor: '#795548', cssBorder: '#3E2723' },
    "mini_boss_minotaur": { name: "Gorehorn", category: "mini_boss", level: 15, maxHp: 30000, atk: 450, def: 60, speed: 2.5, expYield: 8800, goldYield: 4, aggroRadius: 400, chaseRadius: 550, attackRange: 90, width: 90, height: 90, respawnDelay: 120000, cssColor: '#5D4037', cssBorder: '#212121' },
    "floor_boss_minotaur": { name: "Asterion The Labyrinth King", category: "floor_boss", level: 25, maxHp: 150000, atk: 550, def: 400, speed: 3.0, expYield: 38500, goldYield: 6, aggroRadius: 500, chaseRadius: 700, attackRange: 140, width: 140, height: 140, respawnDelay: -1, cssColor: 'linear-gradient(45deg, #4E342E, #b71c1c)', cssBorder: '#b71c1c' },

    // ==================
    // TYPE 7: DRAGONS (Armor Piercing, Fire Breathing)
    // ==================
    "common_dragon": { name: "Dragon Whelp", category: "common_mobs", level: 12, maxHp: 400, atk: 85, def: 10, speed: 3.5, expYield: 1190, goldYield: 3, aggroRadius: 400, chaseRadius: 600, attackRange: 200, width: 50, height: 50, respawnDelay: 12000, cssColor: '#f44336', cssBorder: '#FF9800' },
    "mini_boss_dragon": { name: "Drake of Embers", category: "mini_boss", level: 15, maxHp: 28000, atk: 500, def: 30, speed: 4.0, expYield: 2900, goldYield: 4, aggroRadius: 500, chaseRadius: 700, attackRange: 250, width: 80, height: 80, respawnDelay: 120000, cssColor: '#d32f2f', cssBorder: '#FFeb3b' },
    "floor_boss_dragon": { name: "Ignis The Ancient", category: "floor_boss", level: 25, maxHp: 180000, atk: 800, def: 500, speed: 4.5, expYield: 39500, goldYield: 8, aggroRadius: 700, chaseRadius: 900, attackRange: 300, width: 160, height: 160, respawnDelay: -1, cssColor: 'linear-gradient(45deg, #b71c1c, #FF9800)', cssBorder: '#FFD700' }
};
    ...
    try {
        ...
        socket.on('requestBetaCode', async () => {
            try {
                ...
                // 1. Check if this IP already claimed a code
                ...
                socket.emit('betaCodeResult', { success: false, message: 'Server error while fetching code.' });
            }
        });

        // 4. THIS FIRES AFTER THEY CLICK THE LINK
        socket.on('confirmCodeOpened', async (data) => {
            ...
            try {
                ...
                console.log(`[BETA] Code ID ${data.codeId} claimed by IP: ${clientIp}`);
            } catch (e) {
        ...
        socket.on('login', async (data) => {
            ...
            try {
                ...
                for (const [sid, s] of io.sockets.sockets.entries()) {
                    if (sid !== socket.id) {
                        // 🛡️ DEVICE MULTI-BOX PREVENTER: Max 1 client per Device unless Admin
                        if (!isAdmin(username) && s.username !== username) {
                            if (s.deviceId === safeDeviceId && safeDeviceId !== 'unknown_device') {
                                blockLogin = true;
                                break;
                            }
                        }

                        // If they share a username, mark them for termination
                ...
                if (blockLogin) {
                    console.log(`[SECURITY] Blocked ${username} - Device Cap Reached (Device: ${safeDeviceId})`);
                    return socket.emit('authError', 'Connection Limit: Only 1 game client allowed per device.');
                }
        ...
        socket.on('adminResetDungeons', async (targetName) => {
            ...
            const target = getPlayerById(targetName);
            if (target && target.baseStats) {
                target.baseStats.dungeonEntries = 7;
                target.baseStats.dungeon2Entries = 7;

                await supabase.from('Exonians').update({ base_stats: target.baseStats }).eq('character_name', target.id);
        ...
        socket.on('startDungeon2', async (data) => {
            ...
            // 🛡️ D2 ENTRY VERIFICATION & WEEKLY RESET
            for (let mp of playersToEnter) {
                const now = new Date();
                let dayOfWeek = now.getUTCDay();
                let daysSinceMonday = (dayOfWeek === 0 ? 6 : dayOfWeek - 1);
                let lastMonday = new Date(now.getTime());
                ...
                if (!mp.baseStats.dungeonReset || mp.baseStats.dungeonReset < lastMondayTs) {
                    mp.baseStats.dungeonEntries = 7;
                    mp.baseStats.dungeon2Entries = 7; // Syncs both pools
                    mp.baseStats.dungeonReset = Date.now();
                    await supabase.from('Exonians').update({ base_stats: mp.baseStats }).eq('character_name', mp.id);
                }

                if (mp.baseStats.dungeon2Entries <= 0 && !isAdmin(mp.id)) {
                    playersToEnter.forEach(teammate => {
            ...
            // 🛡️ DEDUCT D2 ENTRIES SECURELY
            playersToEnter.forEach(mp => {
                if (!isAdmin(mp.id) && mp.baseStats) {
                    mp.baseStats.dungeon2Entries = Math.max(0, (mp.baseStats.dungeon2Entries || 7) - 1);
                    supabase.from('Exonians').update({ base_stats: mp.baseStats }).eq('character_name', mp.id).then(() => { });
        ...
        socket.on('tradeEventReward', async (data) => {
            ...
            const tokenItem = {
                ...
                type: 'companion_token', companionClass: data.companionClass,
                rarity: 'Divine', color: '#E040FB', level: 1,
        ...
        socket.on('activateCompanionToken', async (data) => {
            ...
            socket.emit('companionActivated', { companions: p.companions, inventory: p.inventory, companionName: newCompanion.name });
        });
        ...
        socket.on('equipCompanionItem', async (data) => {
            ...
            if (comp.equips[slot]) { p.inventory.push(comp.equips[slot]); }
        ...
        socket.on('unequipCompanionItem', async (data) => {
            ...
            if (p.inventory.length >= 40) { return socket.emit('systemMessage', 'Inventory full! Cannot unequip.'); }
        ...
        socket.on('companionAttack', (data) => {
            ...
            io.to(p.instanceId).emit('monsterDamaged', {
                monsterId: data.monsterId, damage: damage,
                currentHp: m.currentHp, maxHp: m.maxHp, source: 'companion'
            });
            if (m.currentHp <= 0) {
                m.alive = false;
